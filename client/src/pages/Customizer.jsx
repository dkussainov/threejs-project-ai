...
import config from "../config/config"; //to set up backend url
...
import { fadeAnimation, slideAnimation } from "../config/motion"; //animations
  ...
  const handleSubmit = async (type) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://threejs-prroject-ai.onrender.com/api/v1/dalle",
        {
          method: "POST",
